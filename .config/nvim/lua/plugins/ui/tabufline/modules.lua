...
local fn = vim.fn
local tabufline_config = require("core.config").ui.tabufline
...
vim.cmd([[
   function! TbKillBuf(bufnr,b,c,d) 
        call luaeval('require("plugins.ui.tabufline.core").close_buffer(_A)', a:bufnr)
  endfunction]])

vim.cmd("function! TbNewTab(a,b,c,d) \n tabnew \n endfunction")
vim.cmd("function! TbGotoTab(tabnr,b,c,d) \n execute a:tabnr ..'tabnext' \n endfunction")
vim.cmd("function! TbTabClose(a,b,c,d) \n lua require('plugins.ui.tabufline').closeAllBufs('closeTab') \n endfunction")
vim.cmd("function! TbCloseAllBufs(a,b,c,d) \n lua require('plugins.ui.tabufline').closeAllBufs() \n endfunction")
